...
Session.prototype = {
    ...
    get(key){ var m=this.models; return m[key] = m[key] || {} },
    getArray(key){ var m=this.models; return m[key] = m[key] || [] },
    getString(key){ var m=this.models; return m[key] = m[key] || '' },
    getNumber(key){ var m=this.models; return m[key] = m[key] || 0 },
    getSet(key){ var m=this.models; return m[key] = m[key] || new Set },
    getWeakSet(key){ var m=this.models; return m[key] = m[key] || new WeakSet },
    getMap(key){ var m=this.models; return m[key] = m[key] || new Map },
    getWeakMap(key){ var m=this.models; return m[key] = m[key] || new WeakMap },
    set(key, value){
