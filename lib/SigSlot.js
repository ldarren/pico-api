...
proc=function(routes, idx, ctx){
    ...
    run(routes[idx++], 0, ctx, function(err, api){
...
SigSlot.prototype= {
    ...
    signal: function(api, type){
        ...
        proc(routes, 0, SessionMgr.alloc(api, this, type, Array.prototype.slice.call(arguments, arguments.callee.length)))
    },
